                ...
                <div class="p-6 bg-white border-b border-gray-200">
                  <div class="container mt-4">
                   ...
                   <div class="card">
                     ...
                     <div class="card-body">
                       <form method="POST" action="<?php echo e(route('students.update')); ?>" enctype="multipart/form-data">
                         ...
                         <input type="hidden"  name="student_id" id="student_id" value="<?php echo e($student->id); ?>">
                            ...
                            <div class="form-group <?php echo e($errors->has('first_name') ? ' has-error' : ''); ?>" >
                              ...
                              <input type="text" class="form-control" id="first_name" name="first_name" value="<?php echo e($student->first_name); ?>"">
                            ...
                            <div class="form-group <?php echo e($errors->has('last_name') ? ' has-error' : ''); ?>">
                              ...
                              <input type="text" class="form-control" id="last_nameme" name="last_name" value="<?php echo e($student->last_name); ?>">
                            ...
                            <div class="form-group">
                               ...
                               <input type="date"class="form-control"id="dob" name="dob" value="<?php echo e($student->dob); ?>">
...
<?php endif; ?>
<?php /**PATH /home/shilpa/student-record/app/Modules/Students/Views/student-edit.blade.php ENDPATH**/ ?>