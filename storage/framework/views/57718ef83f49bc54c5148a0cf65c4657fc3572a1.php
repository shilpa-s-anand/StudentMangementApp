...
<?php $component->withAttributes([]); ?>
         <?php $__env->slot('logo', null, []); ?> 
                      ...
                      <img  style="height:150px;"src="<?php echo e(url('/images/student-magement-logo.png')); ?>"  alt="Image"/>
...
<?php endif; ?>
        <?php if(Route::has('login')): ?>
                    <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block">
                        ...
                        <?php else: ?>
                            <a href="<?php echo e(route('login')); ?>" class="text-sm text-gray-700 dark:text-gray-500 underline">Alreay a member, Log in</a>
...
<?php endif; ?>
<?php /**PATH /home/shilpa/student-record/resources/views/auth/register.blade.php ENDPATH**/ ?>