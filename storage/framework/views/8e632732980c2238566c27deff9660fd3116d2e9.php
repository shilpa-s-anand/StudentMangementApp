                   ...
                   <div class="card">
                     ...
                     <div class="card-body">
                       <form method="POST" action="<?php echo e(route('students.create')); ?>" enctype="multipart/form-data">
                         <?php echo csrf_field(); ?>
                         <div class="form-group  <?php echo e($errors->has('student') ? ' has-error' : ''); ?>">
                           ...
                           <div class="form-control" style="border: none; padding-left: 0px;">
                             ...
                             <small class="has-error help-block"><?php echo e($errors->first('student')); ?></small>
                             <?php endif; ?>
                           </div>
                         </div>
                         ...
                         <div class="form-group  <?php echo e($errors->has('term') ? ' has-error' : ''); ?>">
                           ...
                           <div class="form-control" style="border: none; padding-left: 0px;">
                             ...
                             <small class="has-error help-block"><?php echo e($errors->first('term')); ?></small>
                             <?php endif; ?>
                           </div>
                         </div>
                            ...
                            <div class="col-md-4 form-group <?php echo e($errors->has('first_name') ? ' has-error' : ''); ?>" >
...
<?php endif; ?>
<?php /**PATH /home/shilpa/student-record/app/Modules/Students/Views/student-add-marks.blade.php ENDPATH**/ ?>